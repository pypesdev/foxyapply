...
import { GetLinkedInProfile, UpdateLinkedInProfile } from '../lib/wailsjs/go/app/App'
import { store } from '../lib/wailsjs/go/models'
...
export function ApplicationsPanel({
  ...
  const handleSaveAndContinue = async () => {
    ...
    try {
      const update = new store.LinkedInProfileUpdate({
        ...profileData,
      })
